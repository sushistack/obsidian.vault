...
유저의 프라이버시와 보안을 최우선으로 고려하여, 개인 식별 정보(PII)를 수집하지 않도록 설계하였습니다. 추적 스크립트는 익명화된 유저 ID를 사용하여 유저를 식별하였고, 데이터 전송 시에는 **SSL/TLS 암호화**를 적용하여 보안을 강화했습니다.

• **꼬리질문:** 이 과정에서 데이터 보호 규정을 준수하기 위해 어떤 조치를 취하셨나요?

**답변:**

GDPR과 같은 데이터 보호 규정을 준수하기 위해, **데이터 최소 수집 원칙**을 따랐습니다. 필요한 최소한의 정보만을 수집하고, 민감한 정보는 저장하지 않았습니다. 또한, 유저에게 데이터 수집에 대한 **명시적인 동의**를 받았고, 언제든지 동의를 철회할 수 있는 옵션을 제공하였습니다.

• **꼬리질문:** 로그 수집 서버에서 민감한 데이터를 어떻게 저장하고 관리하셨나요?

**답변:**

민감한 데이터의 저장을 피하기 위해 수집 단계에서부터 **익명화 및 암호화**를 적용하였습니다. 로그 수집 서버에서는 데이터 접근 권한을 엄격히 통제하고, 정기적인 보안 점검과 로그 모니터링을 통해 **보안 위협을 사전에 감지**하고 대응하였습니다.
...
• **꼬리질문:** 업무 우선순위를 정하고 자원을 효율적으로 배분하기 위해 어떤 전략을 사용하셨나요?

**답변:**

프로젝트 목표 달성에 가장 중요한 기능부터 구현하는 **MoSCoW 기법**을 사용하였습니다. 팀원들의 전문성과 역량에 따라 업무를 배정하여 생산성을 극대화하였고, 긴급한 업무에는 추가 자원을 투입하여 일정을 조율하였습니다.
