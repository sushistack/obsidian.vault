...
제가 티맵에 관심을 가지게 된 계기는 내비를 사용하면서부터입니다, 내비를 사용하면서 유저 별 요청에 대한 최적화된 경로와 공간 데이터를 활용하여 안정적이고 정확하게 서비스를 할 수 있을까? 라는 궁금증으로 부터 출발했습니다. 또 내비와 같은 실시간 성 데이터를 다루는 곳에서 일하고 싶어서 지원하게 되었습니다.
...
2. 또한 v1과 v2의 응답의 동등성이 보장되어야 했습니다.
...
불필요한 컬럼을 제외하고 필요한 데이터만 처리하여 메모리 사용량을 줄였습니다.
